...
7.  **Start Querying!**
    You can interact with Argus AI via the web dashboard or its API:
...
Simple health check endpoint. Returns `{ "status": "ok" }` when the server is running.
